...
def handwritingClassTest():
    ...
    # 1. 导入数据
    hwLabels = []
    trainingFileList = listdir('C:/PythonWorkSp/AiLearning-master/data/2.KNN/trainingDigits')  # load the training set
    ...
    for i in range(m):
        ...
        trainingMat[i, :] = img2vector('C:/PythonWorkSp/AiLearning-master/data/2.KNN/trainingDigits/%s' % fileNameStr)

    # 2. 导入测试数据
    testFileList = listdir('C:/PythonWorkSp/AiLearning-master/data/2.KNN/testDigits')  # iterate through the test set
    errorCount = 0.0
    ...
    for i in range(mTest):
        ...
        fileStr = fileNameStr.split('.')[0]  # take off .txt
        classNumStr = int(fileStr.split('_')[0])
        vectorUnderTest = img2vector('C:/PythonWorkSp/AiLearning-master/data/2.KNN/testDigits/%s' % fileNameStr)
