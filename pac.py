...
def replaceNanWithMean():
    datMat = loadDataSet('C:/PythonWorkSp/AiLearning-master/data/13.PCA/secom.data', ' ')
...
if __name__ == "__main__":
    # # 加载数据，并转化数据类型为float
    dataMat = loadDataSet('C:/PythonWorkSp/AiLearning-master/data/13.PCA/testSet.txt')
    # # 只需要1个特征向量
