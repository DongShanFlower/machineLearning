...
def opencsv():
    print('Load Data...')
    # 使用 pandas 打开
    dataTrain = pd.read_csv(os.path.join('C:/PythonWorkSp/train.csv'))
    dataPre = pd.read_csv(os.path.join( 'C:/PythonWorkSp/test.csv'))
